...
public class Test {
    public static void main(String[] args) throws Exception {
        ...
        isoMessage =
                ...
                "0200F23A400B88A0C008000000000400000016200889999999999930100000000000000010262216270541712216271026102660178000000008000000000390503905200000129491ALTOWBK MOB VIRTUAL ACCOUNT - BBW        JKT  ID3603600101000019991100110014254";
